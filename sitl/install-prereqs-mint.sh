...
# This script is a modified version of install-prereqs-ubuntu.sh
# that has been modified to be ran on Linux mint 20 (Ulyana).
# cd to the directory that install-prereqs-ubuntu.sh is stored:
# `ardupilot/Tools/environmental_install` and run this script instead
...
elif [ ${RELEASE_CODENAME} == 'ulyana' ]; then
    SITLFML_VERSION="2.5"
    SITLCFML_VERSION="2.5"
    PYTHON_V="python3"
    PIP=pip3
